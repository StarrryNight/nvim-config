return {
	...
	config = function()
		...
		local servers = {
			ts_ls = {},
			-- Ruff handles linting and quick-fixes
			ruff = {},

			-- Pyright handles completion and "Go to Definition"
			pyright = {
				settings = {
					pyright = {
					...
					python = {
						analysis = {
							-- Tell Pyright to stop providing linting/diagnostics
							-- so Ruff can do it exclusively.
							ignore = { "*" },
						},
					},
				},
